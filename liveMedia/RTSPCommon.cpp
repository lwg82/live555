...
Boolean parseRTSPRequestString(char const* reqStr,
	...
	// This parser is currently rather dumb; it should be made smarter #####这个解析器目前很愚蠢， 它应该变得更聪明
	// 跳过空格
	// "Be liberal in what you accept": Skip over any whitespace at the start of the request: 自由的接受，跳过请求开始的空白内容
	unsigned i;
