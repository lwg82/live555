...
public:
  static BasicTaskScheduler* createNew(unsigned maxSchedulerGranularity = 10000/*microseconds*/); // 任务粒度
...
protected:
  // Redefined virtual functions:
  virtual void SingleStep(unsigned maxDelayTime); // 在 EventLoop中执行

  virtual void setBackgroundHandling(int socketNum, int conditionSet, BackgroundHandlerProc* handlerProc, void* clientData);
  virtual void moveSocketHandling(int oldSocketNum, int newSocketNum);

protected:
  unsigned fMaxSchedulerGranularity; // 计划任务粒度
